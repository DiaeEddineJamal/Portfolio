...
const GradualBlur: React.FC<PropsWithChildren<GradualBlurProps>> = props => {
  ...
  return (
    <div
      ref={containerRef}
      className={`pointer-events-none transition-opacity duration-300 ease-out isolate ${config.target === 'page' ? 'fixed top-0 left-0 right-0 bottom-0 z-[1000]' : ''} ${config.className}`}
